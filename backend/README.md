...
## Project Structure
    ...
    ├── testapiautoteammemb_94270  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_94270`
...
2. Clone this repo and `cd testapiautoteammemb_94270`
